...
type CartItem struct {
	...
	SkuNum int64 `protobuf:"varint,3,opt,name=skuNum,proto3" json:"skuNum,omitempty"`
}
...
func (x *CartItem) GetSkuNum() int64 {
	if x != nil {
		return x.SkuNum
	}
	return 0
...
var file_order_v1_order_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x06, 0x73, 0x6b, 0x75, 0x4e, 0x75, 0x6d, 0x22, 0x92, 0x01, 0x0a, 0x0c,
