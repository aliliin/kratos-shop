...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09, 0x6f, 0x72, 0x64, 0x65,
	...
	0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x52, 0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x23,
	0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x12, 0x26, 0x0a, 0x05, 0x74, 0x72, 0x61, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x54,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x70, 0x69,
	...
	0x32, 0x16, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x72,
	...
	0x65, 0x6f, 0x75, 0x74, 0x22, 0xc5, 0x03, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x34, 0x0a,
	0x08, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x18, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61,
	...
	0x28, 0x0b, 0x32, 0x15, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44,
	...
	0x77, 0x72, 0x69, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x7a, 0x0a, 0x08,
	0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x12, 0x32, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x73,
	0x75, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72,
	...
	0x52, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x65, 0x22, 0x23, 0x0a, 0x05, 0x54, 0x72, 0x61, 0x63,
	0x65, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x42, 0x1a, 0x5a,
	0x18, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Registry)(nil),            // 3: order.api.Registry
	(*Trace)(nil),               // 4: order.api.Trace
	(*Server_HTTP)(nil),         // 5: order.api.Server.HTTP
	(*Server_GRPC)(nil),         // 6: order.api.Server.GRPC
	(*Data_Database)(nil),       // 7: order.api.Data.Database
	(*Data_Redis)(nil),          // 8: order.api.Data.Redis
	(*Registry_Consul)(nil),     // 9: order.api.Registry.Consul
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	4,  // 2: order.api.Bootstrap.trace:type_name -> order.api.Trace
	5,  // 3: order.api.Server.http:type_name -> order.api.Server.HTTP
	6,  // 4: order.api.Server.grpc:type_name -> order.api.Server.GRPC
	7,  // 5: order.api.Data.database:type_name -> order.api.Data.Database
	8,  // 6: order.api.Data.redis:type_name -> order.api.Data.Redis
	9,  // 7: order.api.Registry.consul:type_name -> order.api.Registry.Consul
	10, // 8: order.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	10, // 9: order.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	10, // 10: order.api.Data.Redis.dial_timeout:type_name -> google.protobuf.Duration
	10, // 11: order.api.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	10, // 12: order.api.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
